...
public class Login extends JFrame implements ActionListener {
   ...
   public Login()  {
      ...
      panel=new JPanel(new GridLayout(3,2)); // El panel se divide en tres renglones y dos columnas.
   ...
   */
   public void actionPerformed(ActionEvent ae)  {
    ...
    /**
     * Este método cierra la ventana login una vez que ha sido ocupada
     */
    public void openTiendaVirtual(){
	TiendaVirtual.muestraInterfaz();
	dispose();
    }
}
